...
public class GamePlay extends GamePlayDomainModel {
	...
	private GamePlayPlayerHand WinningGPPH = null;
	...
	public GamePlayPlayerHand getWinningGPPH() {
		return WinningGPPH;
	}

	public void setWinningGPPH(GamePlayPlayerHand winning_gpph) {
		WinningGPPH = winning_gpph;
	}
